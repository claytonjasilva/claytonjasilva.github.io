# 4. Nível de lógica digital

## 4.1 Álgebra Booleana e Portas Lógicas

### 4.1.1 Álgebra Booleana
#### a. Proposição e valor lógico
...
#### b. Operação lógica de CONJUNÇÃO - *AND*     
...
#### c. Operação lógica de DISJUNÇÃO - *OR*  
A proposição composta *S* resultante da operação de conjunção de duas proposições simples *p* e *q* é indicada por
```
S = p+q
```
...
#### d. Operação INVERSÃO LÓGICA *NOT*  
...
### 4.1.2 Expressões lógicas ou booleanas
