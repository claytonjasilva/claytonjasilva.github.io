# NOTA 2: REPRESENTAÇÃO NUMÉRICA, ARITMÉTICA BINÁRIA E CODIFICAÇÃO
...
## 2. Conversão entre grandezas representadas em bases diferentes

#### 2.1. Conversão da base 10 para a base 2
...
#### 2.2 Conversão da base 2 para a base 10
...
#### 2.3 Conversão entre grandezas hexadecimais e binárias
...
## 4. Representação de números binários negativos

#### 4.1 Representação em sinal e magnitude
...
#### 4.2 Representação em complemento de 1
...
#### 4.3 Representação em complemento de 2
...
#### 4.4 Representação em excesso 2m-1
...
## 5. Representação de números de ponto flutuante
...
## 6. Codificação de elementos discretos**

#### 6.1 Codificação de elementos de conjunto discreto
...
#### 6.2 Códigos de detecção e correção de erros
