# 5. Estruturas de dados homogêneas unidimensionais, bidimensionais e multidimensionais. Ponteiros.

As estruturas homogêneas são aquelas que admitem múltiplos elementos de forma que **todos os elementos são do mesmo tipo**.

## 5.1 Estruturas homogêneas unidimensionais ou *arrays*
...
## 5.3 Estruturas homogêneas multidimensionais
...
### 5.3.1 Declaração de estruturas homogêneas multidimensionais
...
### 5.3.2 Inicialização de estruturas multidimensionais
...
## 5.4 Ponteiros, *arrays* e matrizes
...
### 5.4.1 Declaração de variáveis do tipo ponteiro
...
### 5.4.2 Inicialização de ponteiros
...
### 5.4.3 Conteúdo dos endereços armazenados em variáveis do tipo ponteiro
