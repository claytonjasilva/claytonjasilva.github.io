...
- Quantas voltas um corredor completou em uma pista com perímetro de 400 metros se ele conseguiu correr 2.300 metros? [area.py](https://github.com/claytonjasilva/prog_exemplos/blob/main/volta.py)  
